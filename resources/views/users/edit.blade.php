                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="fater_name" id="fater_name" class="form-control" value="{{ ($users->employee) ? $users->employee->fater_name : '' }}">
                                </div>
                                <div class="mb-3 form-group">
                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="city" id="city" class="form-control" value="{{($users->employee) ? $users->employee->city : ''}}">
                                </div>
                                <div class="mb-3 form-group">
                                    <label class="form-label">Phone Number: <span class="text text-red">*</span></label>
                                    <input type="tel" name="phone_number" id="phone_number" class="form-control" value="{{($users->employee) ? $users->employee->phone_number : ''}}">
                                </div>
                                <div class="mb-3 form-group">
                                    <label class="form-label">Emergency Number: <span class="text text-red">*</span></label>
                                    <input type="tel" name="emergency_phone_number" id="emergency_phone_number" class="form-control" value="{{ ($users->employee) ? $users->employee->emergency_phone_number : ''}}">
                                </div>
                                <div class="mb-3 form-group">
                                    <label class="form-label">Emergency Person Name: <span class="text text-red">*</span></label>
                                    <input type="text" name="emergency_person_name" id="emergency_person_name" class="form-control" value="{{ ($users->employee) ? $users->employee->emergency_person_name : ''}}">
                                </div>
                                <div class="mb-3 form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <select name="gender" id="gender" class="form-control form-select select2" style="width: 100%;">
                                        <option value="" {{ is_null($users->employee) || is_null($users->employee->gender) ? 'selected' : '' }}></option>
                                        <option value="male" {{ $users->employee && $users->employee->gender == 'male' ? 'selected' : '' }}>Male</option>
                                        <option value="female" {{ $users->employee && $users->employee->gender == 'female' ? 'selected' : '' }}>Female</option>
                                    </select>
                                </div>
                                <div class="mb-3 form-group">
                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="date" name="date_of_birth" class="form-control" id="date_of_birth"
                                        placeholder="Date of Birth" value="{{($users->employee) ? $users->employee->date_of_birth : ''}}">
                                </div>
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="date" name="joining_date" id="joining_date" class="form-control" id="dob"
                                        placeholder="Joining Date" value="{{ ($users->employee) ? $users->employee->joining_date : ''}}">
                                </div>
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="address" id="address" class="form-control" id="dob"
                                        placeholder="Enter Your Address" value="{{($users->employee) ? $users->employee->address : ''}}">
                                </div>
                                <div class="mb-3 form-group">
