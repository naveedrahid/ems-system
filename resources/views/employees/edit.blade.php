                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="user_name" id="user_name" class="form-control" value="{{$employees->name}}">
                                </div>
                                <div class="mb-3 form-group">
                                    <label class="form-label">Father Name: <span class="text text-red">*</span></label>
                                    <input type="text" name="fater_name" id="fater_name" class="form-control" value="{{ ($employees->employee) ? $employees->employee->fater_name : '' }}">
                                </div>
                                <div class="mb-3 form-group">
                                    <label class="form-label">Email address: <span class="text text-red">*</span></label>
                                    <input type="email" name="user_email" id="user_email" class="form-control" value="{{$employees->email}}">
                                </div>
                                <div class="mb-3 form-group">
                                    <label class="form-label">City: <span class="text text-red">*</span></label>
                                    <input type="text" name="city" id="city" class="form-control" value="{{($employees->employee) ? $employees->employee->city : ''}}">
                                </div>
                                <div class="mb-3 form-group">
                                    <label class="form-label">Phone Number: <span class="text text-red">*</span></label>
                                    <input type="tel" name="phone_number" id="phone_number" class="form-control" value="{{($employees->employee) ? $employees->employee->phone_number : ''}}">
                                </div>
                                <div class="mb-3 form-group">
                                    <label class="form-label">Emergency Number: <span class="text text-red">*</span></label>
                                    <input type="tel" name="emergency_phone_number" id="emergency_phone_number" class="form-control" value="{{ ($employees->employee) ? $employees->employee->emergency_phone_number : ''}}">
                                </div>
                                <div class="mb-3 form-group">
                                    <label class="form-label">Emergency Person Name: <span class="text text-red">*</span></label>
                                    <input type="text" name="emergency_person_name" id="emergency_person_name" class="form-control" value="{{ ($employees->employee) ? $employees->employee->emergency_person_name : ''}}">
                                </div>
                                <div class="mb-3 form-group">
                                    ...
                                    <select name="status" id="status" class="form-control form-select select2"
                                        ...
                                        <option value="deactive" {{ $employees->status == 'deactive' ? 'selected' : '' }}>DeActive
                                        </option>
                                    </select>   
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <select name="gender" id="gender" class="form-control form-select select2" style="width: 100%;">
                                        <option value="" {{ is_null($employees->employee) || is_null($employees->employee->gender) ? 'selected' : '' }}></option>
                                        <option value="male" {{ $employees->employee && $employees->employee->gender == 'male' ? 'selected' : '' }}>Male</option>
                                        <option value="female" {{ $employees->employee && $employees->employee->gender == 'female' ? 'selected' : '' }}>Female</option>
                                    </select>
                                </div>
                                <div class="mb-3 form-group">
                                    ...
                                    <select name="user_role" id="author_feature" class="form-control form-select select2"
                                        ...
                                        <option value="{{ $roleId }}" {{ $employees->role_id == $roleId ? 'selected' : '' }}>{{ $roleName }}</option>
                                    @endforeach
                                    </select>
                                </div>
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="date" name="date_of_birth" class="form-control" id="date_of_birth"
                                        placeholder="Date of Birth" value="{{($employees->employee) ? $employees->employee->date_of_birth : ''}}">
                                </div>
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="date" name="joining_date" id="joining_date" class="form-control" id="dob"
                                        placeholder="Joining Date" value="{{ ($employees->employee) ? $employees->employee->joining_date : ''}}">
                                </div>
                                <div class="mb-3 form-group">
